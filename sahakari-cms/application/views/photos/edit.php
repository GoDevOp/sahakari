...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
    	<div class="container">
        <div class="col-lg-12">
        <div class="form-group  pull-right"><a href="<?php echo site_url("photos"); ?>" class="btn btn-default">Cancel</a>
        </div>
        </div>
        <form role="form" method="post" action="" enctype="multipart/form-data">
            <div class="col-lg-8">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="photo_title" name="photo_title" value="<?php echo $photo->photo_title;?>">
              </div>
            </div>
            <div class="col-lg-8">
              <div class="form-group">
                <label for="photo_caption">Caption</label>
                <input type="text" class="form-control" id="photo_caption" name="photo_caption" value="<?php echo $photo->photo_caption;?>">
              </div>
            </div>    
        <div class="col-lg-8">
		<style type="text/css">
		...
		#photo-container img {
          ...
          <div class="form-group">
            ...
            <div id="photo-container" onclick="openKCFinder(this)"><div style="margin:5px">
            <img src="<?php echo base_url()."../".$photo->photo;?>"></div></div><a href="#" onclick="removeCover()">Remove Photo</a>
          </div>
        </div> 
          <div class="col-lg-12">
