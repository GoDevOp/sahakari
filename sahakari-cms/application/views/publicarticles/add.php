    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <textarea name="article_description" class="form-control ckeditor" id="article_description"></textarea>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label for="article_date">Article Date</label>
            <input type="text" class="datepicker form-control" id="article_date" name="article_date" >
          </div>
        </div>    
        <div class="col-lg-4">
          <div class="form-group">
            <label for="article_writer">Writer Name</label>
            <input type="text" class="form-control" id="article_writer" name="article_writer">
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label for="article_tagline">Writer tagline</label>
            <input type="text" class="form-control" id="article_tagline" name="article_tagline" placeholder="">
          </div>
        </div>
