    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="advertisement_title" name="advertisement_title">
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label for="advertisement_url">URL</label>
            <input type="text" class="form-control" id="advertisement_url" name="advertisement_url">
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label for="from_date">From</label>
            <input type="text" class="datepicker form-control" id="from_date" name="from_date" >
          </div>
        </div>
        <div class="col-lg-4">
        <div class="form-group">
