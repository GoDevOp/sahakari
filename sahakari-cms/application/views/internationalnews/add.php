...
<html lang="en">
  ...
  <body>
    ...
    <div class="row">
    	<div class="container">
        <div class="col-lg-12">
        <div class="form-group  pull-right"><a href="<?php echo site_url("internationalnews"); ?>" class="btn btn-default">Cancel</a>
        </div>
        </div>
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="datepicker form-control" id="added_on" name="added_on" >
          </div>
        </div>
          <div class="col-lg-5">
		<style type="text/css">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <input type="text" name="news_desc" id="news_desc" class="form-control" />
          </div>
        </div>  
        <div class="col-lg-12">
          <div class="form-group">
            <label for="news_text">Full News Text</label>
            <textarea name="news_text" class="form-control ckeditor" id="news_text"></textarea>
          </div>
        </div>
