    ...
    <div class="row">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="person_address" name="person_address" placeholder="e.g Putalisadak,Ktm">
          </div>
        </div>
        <div class="col-lg-12">
          <div class="form-group">
            <label for="success_story">Stories</label>
            <textarea name="success_story" class="form-control ckeditor" id="success_story"></textarea>
          </div>
        </div>
         <div class="col-lg-5">
		<style type="text/css">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="datepicker form-control" id="collected_on" name="collected_on" >
          </div>
        </div>        
          <div class="col-lg-12">
