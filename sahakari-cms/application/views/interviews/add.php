    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="interview_title" name="interview_title">
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label for="interview_with">Interview With</label>
            <input type="text" class="form-control" id="interview_with" name="interview_with">
          </div>
        </div>
        <div class="col-lg-4">
          <div class="form-group">
            <label for="interview_date">Interview Date</label>
            <input type="text" class="datepicker form-control" id="interview_date" name="interview_date" >
          </div>
        </div>
        <div class="col-lg-4">
        <div class="form-group">
            <label for="interview_date">Interview By</label>
            <input type="text" class="form-control" id="interview_by" name="interview_by" >
          </div>
        </div>
       <div class="col-lg-5">
		<style type="text/css">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <textarea name="interview_text" class="form-control ckeditor" id="interview_text"></textarea>
          </div>
        </div>  
        <div class="col-lg-12">
          <div class="form-group">
            <label for="interview_remarks">Interview Remarks</label>
            <textarea name="interview_remarks" class="form-control ckeditor" id="interview_remarks"></textarea>
          </div>
        </div>  
          <div class="col-lg-12">
