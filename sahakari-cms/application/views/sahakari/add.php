    ...
    <div class="row">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="sahakari_name" name="sahakari_name">
          </div>
        </div>
        <div class="col-lg-12">
          <div class="form-group">
            <label for="sahakari_address">Sahakari Address</label>
            <input type="text" class="form-control" id="sahakari_address" name="sahakari_address">
          </div>
        </div>
        <div class="col-lg-12">
          <div class="form-group">
            <label for="short_intro">Short Intro</label>
            <textarea class="form-control ckeditor" id="short_intro" name="short_intro"></textarea>
          </div>
        </div>
        <div class="col-lg-12">
          <div class="form-group">
            <label for="sahakari_email">Email</label>
            <input type="text" class="form-control" id="sahakari_email" name="sahakari_email">
          </div>
        </div>
        <div class="col-lg-12">
          <div class="form-group">
            <label for="facebook_email">Facebook Email</label>
            <input type="text" class="form-control" id="facebook_email" name="facebook_email">
          </div>
        </div>
        <div class="col-lg-12">
          <div class="form-group">
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="membership_by" name="membership_by">
          </div>
        </div>
        <div class="col-lg-12">
          <div class="form-group">
            <label for="remarks">Ramarks</label>
            <textarea class="form-control ckeditor" id="remarks" name="remarks"></textarea>
          </div>
        </div>
        <div class="col-lg-5">
		<style type="text/css">
