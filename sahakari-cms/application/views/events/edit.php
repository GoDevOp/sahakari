    ...
    <div class="row">
        ...
        <div class="col-lg-4">
          <div class="form-group">
            ...
            <input type="text" class="datepicker form-control" id="event_date" name="event_date" value="<?php echo $Event->event_date; ?>" >
          </div>
        </div>
        <div class="col-lg-12">
          <div class="form-group">
            <label for="Event_text">Event Details</label>
            <textarea name="event_details" class="form-control ckeditor" id="event_details"><?php echo $Event->event_details; ?></textarea>
          </div>
        </div>
